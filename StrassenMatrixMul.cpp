...
a00   a11           b00   b01            t + s - q + u         p + q
a10   a11     *     b10   b11     =          r + s         p + t - r - v    
...
multiply_matrix(vector<vector<int> > matrix_A,
	...
	if (col_1 == 1)
		...
		vector<vector<int> > result_matrix_00(add_matrix(
			add_matrix(add_matrix(t, s, split_index), u, split_index),
			q, split_index, -1));
		...
		vector<vector<int> > result_matrix_11(add_matrix(
			add_matrix(add_matrix(t, p, split_index), r, split_index, -1),
			v, split_index, -1));
